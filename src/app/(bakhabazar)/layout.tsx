...
import { bebasNeue, oswald, dmSans, nunitoSans } from "@/app/fonts";

export const metadata: Metadata = {
  title: "Bakha Bazar",
  description: "AI based platform for Nepali History and Culture",
};
...
export default async function RootLayout({
  ...
  try {
    ...
    if (!res.ok) throw new Error(`Failed to fetch initial story list: ${res.status}`);
    ...
    console.error("Error fetching initial podcast data:", err);
    firstPodcast = null;
  }
  ...
  return (
    <html lang="en">
      ...
      >
        <AuthProvider>
          <SidebarProvider className="h-screen w-full overflow-hidden lg:p-2" defaultOpen={false}>
            <Csrf />
